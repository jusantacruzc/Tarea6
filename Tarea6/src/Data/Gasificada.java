...
public class Gasificada extends Bebidas {
    ...
    public Gasificada(boolean ExcesoSodio, boolean ExcesoAzucar, boolean ContieneEndulcorantes, float medidaEnMl, Date fechaCaducidad, String impuesto) {
    ...
    public String toString() {
        return super.toString() + "\nGasificada{" + "ExcesoSodio=" + ExcesoSodio + ", ExcesoAzucar=" + ExcesoAzucar + ", ContieneEndulcorantes=" + ContieneEndulcorantes + ", idGaseosa=" + idGaseosa + '}';
    }
